...
@log_actions
def cpu_current():
    return get_current("cpu_samples")


@app.route("/cpu/avg24h")
@log_actions
def cpu_avg24h():
    return get_avg24h("cpu_samples")
...
@log_actions
def mem_current():
    return get_current("mem_samples")


@app.route("/mem/avg24h")
@log_actions
def mem_avg24h():
    return get_avg24h ("mem_samples")
...
@log_actions
def disk_current():
    return get_current("disk_samples")


@app.route("/disk/avg24h")
@log_actions
def disk_avg24h():
    return get_avg24h("disk_samples")
